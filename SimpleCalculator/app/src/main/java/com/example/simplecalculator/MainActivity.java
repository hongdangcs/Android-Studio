...
public class MainActivity extends Activity {
    ...
    private com.example.simplecalculator.Calculator mCalculator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCalculator = new com.example.simplecalculator.Calculator();
    ...
    public void onAdd(View view) {
        compute(com.example.simplecalculator.Calculator.Operator.ADD);
    }
    ...
    public void onSub(View view) {
        compute(com.example.simplecalculator.Calculator.Operator.SUB);
    }
    ...
    public void onDiv(View view) {
        try {
            compute(com.example.simplecalculator.Calculator.Operator.DIV);
    ...
    public void onMul(View view) {
        compute(com.example.simplecalculator.Calculator.Operator.MUL);
    }

    private void compute(com.example.simplecalculator.Calculator.Operator operator) {
        double operandOne;
        double operandTwo;
        try {
